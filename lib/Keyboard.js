...
var _NorwegianLayout = require('./layouts/NorwegianLayout');

var _NorwegianLayout2 = _interopRequireDefault(_NorwegianLayout);
...
var _KeyboardBackspaceButton = require('./KeyboardBackspaceButton');

var _KeyboardBackspaceButton2 = _interopRequireDefault(_KeyboardBackspaceButton);
  ...
  _createClass(Keyboard, [{
    ...
    value: function getKeys() {
      ...
      if (this.state.showSymbols) {
        ...
        keysSet = _NorwegianLayout2.default;
    ...
    value: function isUppercase() {
      ...
      return inputNode.type !== 'password' && dataset.type !== 'email' && !inputNode.value.length && isFirstLetterUppercase;
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_KeyboardBackspaceButton2.default, {
          ...
          keys.map(function (row, i) {
            return _react2.default.createElement(
              ...
              keys.length === i + 1 && _react2.default.createElement(_KeyboardButton2.default, {
